...
Only the chamber is trimmed at the lid seating plane. The complete wall-contact frame stays intact, including corners that extend past that plane beside the lid. Small solid wedges join the trimmed chamber back to the frame wherever the cut would leave a triangular gap. These are confined to the wall-side clearance band and leave the open back intact. PCB placement is unchanged; the lid, rigid PCB ring and screw bearing pads retain their clearance. The existing corner-tip setback and intentional cable passages still apply.
...
With the redundant rear panels removed, the compact body's solid CAD volume is about 49.4 cm³ versus 55.7 cm³ for the original cable-off print. Actual sliced filament depends on orientation, infill and supports.
